...
int main() {
  ...
  insert(arr, Conic_arc(Rat_segment(Rat_point(0, 0), Rat_point(1, 0))));
  insert(arr, Conic_arc(0, 0, 0, 0, 1, 0, CGAL::COLLINEAR,
                        Point(0, 0), Point(-1, 0)));
  insert(arr, Conic_arc(Rat_segment(Rat_point(0, -1), Rat_point(0, 0))));
  insert(arr, Conic_arc(1, 4, 0, 0, 0, -1));
