...
ksr.reconstruct_with_ground(0.5, vtx.append, polylist.append)

if len(polylist) > 0:
    print(len(polylist), " faces in reconstruction")
    CGALPY.write_polygon_soup("building_0.5.ply", vtx, polylist)
