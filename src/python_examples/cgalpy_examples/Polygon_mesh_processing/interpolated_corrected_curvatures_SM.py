...
mean_curvature_map, created = mesh.add_property_map_vertex_float("v:mean_curvature_map", 0)
assert created

Gaussian_curvature_map, created = mesh.add_property_map_vertex_float("v:Gaussian_curvature_map", 0)
assert created

principal_curvatures_and_directions_map, created = mesh.add_property_map_vertex_Principal_curvatures_and_directions(
  "v:principal_curvatures_and_directions_map",
  Pmp.Principal_curvatures_and_directions(0, 0, Ker.Vector_3(0, 0, 0), Ker.Vector_3(0, 0, 0)))
assert created
