...
void export_circle_3(C& c) {
  ...
  c.def(py::init<const Pnt_3&, const FT&, const Pln_3&>(),
    ...
    .def(py::init<const Pln_3&, const Sphere_3&>(),
         ...
         "introduces a variable c of type Circle_3.")
    .def("center", &Circle_3::center,        "returns the center of c.")
    .def("squared_radius", &Circle_3::squared_radius,        "returns the squared radius of c.")
    .def("supporting_plane", &Circle_3::supporting_plane,        "returns the supporting plane of c.")
    .def("diametral_sphere", &Circle_3::diametral_sphere,        "returns the diametral sphere of c.")
    .def("area_divided_by_pi", &Circle_3::area_divided_by_pi,        "returns the area of c, divided by π.")
    .def("approximate_area", &Circle_3::approximate_area,        "returns an approximation of the area of c.")
    .def("squared_length_divided_by_pi_square", &Circle_3::squared_length_divided_by_pi_square,        "returns the squared length of c, divided by π^2.")
    .def("approximate_squared_length", &Circle_3::approximate_squared_length,        "returns an approximation of the squared length (i.e. perimeter) of c.")
    .def("has_on", &Circle_3::has_on,
         py::arg("p"))
    .def("bbox", &Circle_3::bbox,        "returns a bounding box containing c.")
    .def(py::self == py::self,
