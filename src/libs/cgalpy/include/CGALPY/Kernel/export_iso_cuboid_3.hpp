...
void export_iso_cuboid_3(C& c) {
  ...
  c.def(py::init<const Pt&, const Pt&>(), py::arg("p"), py::arg("q"), doc::Iso_cuboid_3_Iso_cuboid_3)
    .def(py::init<const Pt&, const Pt&, int>(), doc::Iso_cuboid_3_Iso_cuboid_3_1)
    ...
    .def(py::init<const Rt&, const Rt&, const Rt&,
         ...
         py::arg("hw") = Rt(1))
    .def(py::init<const CGAL::Bbox_3&>(), py::arg("bbox"), doc::Iso_cuboid_3_Iso_cuboid_3_2)
