...
void export_line_2(C& c) {
  ...
  c.def(py::init<Rt&, Rt&, Rt&>(), doc::Line_2_Line_2)
    ...
    .def("projection", &Lin::projection, doc::Line_2_projection)    .def("direction", &Lin::direction, doc::Line_2_direction)    .def("to_vector", &Lin::to_vector, doc::Line_2_to_vector)    .def("opposite", &Lin::opposite, doc::Line_2_opposite)    .def("transform", &Lin::transform, doc::Line_2_transform)    .def("perpendicular", &Lin::perpendicular, doc::Line_2_perpendicular)    .def("x_at_y", &Lin::x_at_y, doc::Line_2_x_at_y)    .def("y_at_x", &Lin::y_at_x, doc::Line_2_y_at_x)    .def("__str__", to_string<Lin>)
