...
void export_bgl_iterators(py::module_& m) {
  // Iterators
  m.def("halfedges_around_target", &bgl::halfedges_around_target_h<Graph>, py::arg("h"), py::arg("g"),
        "Obtain an iterator over all halfedges with vertex target(h,g) as target.");
  m.def("halfedges_around_target", &bgl::halfedges_around_target_v<Graph>, py::arg("v"), py::arg("g"),
        "Obtain an iterator over all halfedges with vertex v as target.");
  m.def("halfedges_around_source", &bgl::halfedges_around_source_v<Graph>, py::arg("v"), py::arg("g"),
        "Obtain an iterator over all halfedges with vertex v as source.");
  m.def("halfedges_around_source", &bgl::halfedges_around_source_h<Graph>, py::arg("h"), py::arg("g"),
        "Obtain an iterator over all halfedges with vertex source(h,g) as source.");
  m.def("halfedges_around_face", &bgl::halfedges_around_face<Graph>, py::arg("h"), py::arg("g"),
        "Obtain an iterator over all halfedges incident to the same face or border as h.");
  m.def("faces_around_target", &bgl::faces_around_target<Graph>, py::arg("h"), py::arg("g"),
        "Obtain an iterator over all faces around vertex target(h,g).");
  m.def("faces_around_face", &bgl::faces_around_face<Graph>, py::arg("h"), py::arg("g"),
        "Obtain an iterator over all edge-adjacent faces to the same face face(h,g).");
  m.def("vertices_around_target", &bgl::vertices_around_target<Graph>, py::arg("h"), py::arg("g"),
        "Obtain an iterator over all vertices adjacent to the vertex target(h,g).");
  m.def("vertices_around_face", &bgl::vertices_around_face<Graph>, py::arg("h"), py::arg("g"),
  ...
  m.def("halfedges_around_target_circulator", &bgl::halfedges_around_target_v_circulator<Graph>,
        py::arg("v"), py::arg("g"),
  ...
  m.def("halfedges_around_source_circulator", &bgl::halfedges_around_source_h_circulator<Graph>,
        py::arg("h"), py::arg("g"),
