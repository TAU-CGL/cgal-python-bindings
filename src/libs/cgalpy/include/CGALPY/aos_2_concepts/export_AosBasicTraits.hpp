...
bp::class_<Type>* add_class_object(bp::scope& my_scope) {
  bp::handle<> tco(bp::objects::registered_class_object(bp::type_id<Type>()));
  if (tco.get() == 0) return new bp::class_<Type>(Name, bp::no_init);
...
void export_AosBasicTraits(C c, Concepts& concepts) {
  ...
  classes.m_compare_x_2 = add_class_object<Compare_x_2, compare_x_2>(traits_scope);
  ...
  classes.m_compare_xy_2 = add_class_object<Compare_xy_2, compare_x_2>(traits_scope);
  ...
  classes.m_construct_min_vertex_2 =
    add_class_object<Construct_min_vertex_2, construct_min_vertex_2>(traits_scope);
  ...
  classes.m_construct_max_vertex_2 =
    add_class_object<Construct_max_vertex_2, construct_max_vertex_2>(traits_scope);
  ...
  classes.m_is_vertical_2 = add_class_object<Is_vertical_2, is_vertical_2>(traits_scope);
  ...
  classes.m_compare_y_at_x_2 =
    add_class_object<Compare_y_at_x_2, compare_y_at_x_2>(traits_scope);
  ...
  classes.m_compare_y_at_x_right_2 =
    add_class_object<Compare_y_at_x_right_2, compare_y_at_x_right_2>(traits_scope);
  ...
  classes.m_equal_2 = add_class_object<Equal_2, equal_2>(traits_scope);
