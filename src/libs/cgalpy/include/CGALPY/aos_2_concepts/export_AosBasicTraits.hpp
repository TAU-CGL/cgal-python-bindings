...
template <typename Type, const char* Name, typename RVP = bp::default_call_policies>
void add_class_object(bp::scope& my_scope, bp::class_<Type>*& co) {
  bp::handle<> tco(bp::objects::registered_class_object(bp::type_id<Type>()));
  if (tco.get() != 0) my_scope.attr(Name) = tco;
  else {
    co = new bp::class_<Type>(Name, bp::no_init);
    co->def("__call__", &Type::operator(), RVP());
  }
}
...
void export_compare_at_x_left_2(C c, Classes& classes, CGAL::Tag_true) {
  ...
  add_class_object<Compare_y_at_x_left_2, compare_y_at_x_left_2>
...
void export_AosBasicTraits(C c, Concepts& concepts) {
  ...
  add_class_object<Compare_x_2, compare_x_2>(traits_scope, classes.m_compare_x_2);

  // Compare_xy_2
  static const char compare_xy_2[] = "Compare_xy_2";
  add_class_object<Compare_xy_2, compare_x_2>(traits_scope, classes.m_compare_xy_2);

  // Construct_min_vertex_2
  static const char construct_min_vertex_2[] = "Construct_min_vertex_2";
  add_class_object<Construct_min_vertex_2, construct_min_vertex_2, RVP>
    (traits_scope, classes.m_construct_min_vertex_2);

  // Construct_max_vertex_2
  static const char construct_max_vertex_2[] = "Construct_max_vertex_2";
  add_class_object<Construct_max_vertex_2, construct_max_vertex_2, RVP>
    (traits_scope, classes.m_construct_max_vertex_2);

  // Is_vertical_2
  static const char is_vertical_2[] = "Is_vertical_2";
  add_class_object<Is_vertical_2, is_vertical_2>(traits_scope, classes.m_is_vertical_2);
  ...
  // Equal_2
  bp::handle<> eq_co(bp::objects::registered_class_object(bp::type_id<Equal_2>()));
  if (eq_co.get() != 0) traits_scope.attr("Equal_2") = eq_co;
  else {
    classes.m_equal_2 = new bp::class_<Equal_2>("Equal_2", bp::no_init);
