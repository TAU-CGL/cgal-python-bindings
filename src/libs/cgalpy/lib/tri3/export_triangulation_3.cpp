...
void export_triangulation_3_vertex(py::class_<cgalpy::tri3::Triangulation_3>&);
void export_triangulation_3_cell(py::class_<cgalpy::tri3::Triangulation_3>&);
...
void export_triangulation_3(py::module_& m) {
  ...
  export_triangulation_3_vertex(tri_c);
  export_triangulation_3_cell(tri_c);
