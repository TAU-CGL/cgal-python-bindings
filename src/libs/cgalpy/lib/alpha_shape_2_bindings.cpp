...
void export_alpha_shape_2(py::module_& m) {
  ...
  as2_c.def(py::init<>())
    ...
    .def(py::init<Tri2&, double, as2::Mode>(), py::arg("triangulation"), py::arg("alpha"), py::arg("mode") = As2::GENERAL)
    .def(py::init<Tri2&, as2::FT&, as2::Mode>(), py::arg("triangulation"), py::arg("alpha"), py::arg("mode") = As2::GENERAL)
    ...
    .def("get_nth_alpha", &As2::get_nth_alpha, py::arg("n"), ri)
    ...
    .def("find_optimal_alpha", &As2::find_optimal_alpha, py::arg("nb_components"))
    ...
    .def("classify", classify5, py::arg("face"), py::arg("i"), py::arg("alpha"))
