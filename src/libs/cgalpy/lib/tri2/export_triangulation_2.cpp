...
void export_triangulation_2_vertex(py::class_<cgalpy::tri2::Triangulation_2, CGAL::Triangulation_cw_ccw_2>&);
void export_triangulation_2_face(py::class_<cgalpy::tri2::Triangulation_2, CGAL::Triangulation_cw_ccw_2>&);
...
void export_triangulation_2(py::module_& m) {
  ...
  export_triangulation_2_vertex(tri_c);
  export_triangulation_2_face(tri_c);
