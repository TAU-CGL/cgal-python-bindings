...
void export_meshing(py::module_& m) {
  ...
  using FacePatchMap = boost::property_map<Pm, CGAL::dynamic_face_property_t<std::size_t>>::type;
  using VertexCornerMap = boost::property_map<Pm, CGAL::dynamic_vertex_property_t<std::size_t>>::type;
