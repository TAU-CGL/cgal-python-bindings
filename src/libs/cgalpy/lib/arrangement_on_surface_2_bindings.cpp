...
// 3D Envelopes
  ...
  if (! add_attr<Ao>(m, "Arr_observer")) {
    py::class_<Ao, Aob>(m, "Arr_observer")
      ...
      .def(py::init<Aos&>(), py::keep_alive<1, 2>())
      //
      .def("set_after_split_face", &Ao::set_after_split_face, ka_1_2)
      .def("set_before_assign", &Ao::set_before_assign, ka_1_2)
      .def("set_after_assign", &Ao::set_after_assign, ka_1_2)
      .def("set_before_clear", &Ao::set_before_clear, ka_1_2)
      .def("set_after_clear", &Ao::set_after_clear, ka_1_2)
      .def("set_before_global_change", &Ao::set_before_global_change, ka_1_2)
      .def("set_after_global_change", &Ao::set_after_global_change, ka_1_2)
      .def("set_before_attach", &Ao::set_before_attach, ka_1_2)
      .def("set_after_attach", &Ao::set_after_attach, ka_1_2)
      .def("set_before_detach", &Ao::set_before_detach, ka_1_2)
      .def("set_after_detach", &Ao::set_after_detach, ka_1_2)
      .def("set_before_create_vertex", &Ao::set_before_create_vertex, ka_1_2)
      .def("set_after_create_vertex", &Ao::set_after_create_vertex, ka_1_2)
      .def("set_before_create_boundary_vertex1",
           &Ao::set_before_create_boundary_vertex1, ka_1_2)
      .def("set_before_create_boundary_vertex2",
           &Ao::set_before_create_boundary_vertex2, ka_1_2)
      .def("set_after_create_boundary_vertex",
           &Ao::set_after_create_boundary_vertex, ka_1_2)
      .def("set_before_create_edge", &Ao::set_before_create_edge, ka_1_2)
      .def("set_after_create_edge", &Ao::set_after_create_edge, ka_1_2)
      .def("set_before_modify_vertex", &Ao::set_before_modify_vertex, ka_1_2)
      .def("set_after_modify_vertex", &Ao::set_after_modify_vertex, ka_1_2)
      .def("set_before_modify_edge", &Ao::set_before_modify_edge, ka_1_2)
      .def("set_after_modify_edge", &Ao::set_after_modify_edge, ka_1_2)
      .def("set_before_split_edge", &Ao::set_before_split_edge, ka_1_2)
      .def("set_after_split_edge", &Ao::set_after_split_edge, ka_1_2)
      .def("set_before_split_fictitious_edge",
           &Ao::set_before_split_fictitious_edge, ka_1_2)
      .def("set_after_split_fictitious_edge",
           &Ao::set_after_split_fictitious_edge, ka_1_2)
      .def("set_before_split_face", &Ao::set_before_split_face, ka_1_2)
      .def("set_after_split_face", &Ao::set_after_split_face, ka_1_2)
      .def("set_before_split_outer_ccb", &Ao::set_before_split_outer_ccb, ka_1_2)
      .def("set_after_split_outer_ccb", &Ao::set_after_split_outer_ccb, ka_1_2)
      .def("set_before_split_inner_ccb", &Ao::set_before_split_inner_ccb, ka_1_2)
      .def("set_after_split_inner_ccb", &Ao::set_after_split_inner_ccb, ka_1_2)
      .def("set_before_add_outer_ccb", &Ao::set_before_add_outer_ccb, ka_1_2)
      .def("set_after_add_outer_ccb", &Ao::set_after_add_outer_ccb, ka_1_2)
      .def("set_before_add_inner_ccb", &Ao::set_before_add_inner_ccb, ka_1_2)
      .def("set_after_add_inner_ccb", &Ao::set_after_add_inner_ccb, ka_1_2)
      .def("set_before_add_isolated_vertex",
           &Ao::set_before_add_isolated_vertex, ka_1_2)
      .def("set_after_add_isolated_vertex",
           &Ao::set_after_add_isolated_vertex, ka_1_2)
      ...
      .def("set_before_merge_face", &Ao::set_before_merge_face, ka_1_2)
      .def("set_after_merge_face", &Ao::set_after_merge_face, ka_1_2)
      .def("set_before_merge_outer_ccb", &Ao::set_before_merge_outer_ccb, ka_1_2)
      .def("set_after_merge_outer_ccb", &Ao::set_after_merge_outer_ccb, ka_1_2)
      .def("set_before_merge_inner_ccb", &Ao::set_before_merge_inner_ccb, ka_1_2)
      .def("set_after_merge_inner_ccb", &Ao::set_after_merge_inner_ccb, ka_1_2)
      .def("set_before_move_outer_ccb", &Ao::set_before_move_outer_ccb, ka_1_2)
      .def("set_after_move_outer_ccb", &Ao::set_after_move_outer_ccb, ka_1_2)
      .def("set_before_move_inner_ccb", &Ao::set_before_move_inner_ccb, ka_1_2)
      .def("set_after_move_inner_ccb", &Ao::set_after_move_inner_ccb, ka_1_2)
      .def("set_before_move_isolated_vertex",
           &Ao::set_before_move_isolated_vertex, ka_1_2)
      .def("set_after_move_isolated_vertex",
           &Ao::set_after_move_isolated_vertex, ka_1_2)
      .def("set_before_remove_vertex", &Ao::set_before_remove_vertex, ka_1_2)
      .def("set_after_remove_vertex", &Ao::set_after_remove_vertex, ka_1_2)
      .def("set_before_remove_edge", &Ao::set_before_remove_edge, ka_1_2)
      .def("set_after_remove_edge", &Ao::set_after_remove_edge, ka_1_2)
      .def("set_before_remove_outer_ccb",
           &Ao::set_before_remove_outer_ccb, ka_1_2)
      .def("set_after_remove_outer_ccb",
           &Ao::set_after_remove_outer_ccb, ka_1_2)
      .def("set_before_remove_inner_ccb",
           &Ao::set_before_remove_inner_ccb, ka_1_2)
      .def("set_after_remove_inner_ccb",
           &Ao::set_after_remove_inner_ccb, ka_1_2)
      ;
  }
}
