...
#include "cgalpy/Polygon_docstrings.hpp"
  ...
  if (! add_attr<Pgn>(m, "Polygon_2")) {
    ...
    pgn_c.def(py::init<>(), doc::Polygon_2_Polygon_2)
      ...
      .def("right_vertex", &pol2::right_vertex,
           doc::Polygon_2_right_vertex)
      .def("top_vertex", &pol2::top_vertex,
           doc::Polygon_2_top_vertex)
      .def("bottom_vertex", &pol2::bottom_vertex,
           doc::Polygon_2_bottom_vertex)
