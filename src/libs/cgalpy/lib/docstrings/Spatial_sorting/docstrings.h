...
#ifndef CGAL_PYTHON_DOCSTRINGS_SPATIAL_SORTING_H
#define CGAL_PYTHON_DOCSTRINGS_SPATIAL_SORTING_H
...
constexpr const char* SpatialSortingTraits_2__class__ = "All 2D spatial sorting algorithms provided in CGAL are parameterized by a traits class Traits , which defines the primitives (objects and predicates) that the sorting algorithms use. SpatialSortingTraits_2 defines the complete set of primitives required in these functions and functors.";

constexpr const char* SpatialSortingTraits_2_Point_2 = "The point type on which the sorting algorithms operate.

Returns: unspecified_type";
constexpr const char* SpatialSortingTraits_2_Compute_x_2 = "Functor object type returning the $ x$ coordinate of a Point_2 .

Must provide FT operator()(Point_2 p) where FT can be used as argument of
CGAL::to_double .

Returns: unspecified_type";
constexpr const char* SpatialSortingTraits_2_Compute_y_2 = "Functor object type returning the $ y$ coordinate of a Point_2 .

Must provide FT operator()(Point_2 p) where FT can be used as argument of
CGAL::to_double .

Returns: unspecified_type";
constexpr const char* SpatialSortingTraits_2_Less_x_2 = "Binary predicate object type comparing Point_2 s along the $ x$ coordinate.

Must provide bool operator()(Point_2 p, Point_2 q) where true is returned iff
$ p_x < q_x$ , where $ p_x$ and $ q_x$ denote $ x$ coordinate of point $ p$
and $ q$ , respectively.

Returns: unspecified_type";
constexpr const char* SpatialSortingTraits_2_Less_y_2 = "Binary predicate object type comparing Point_2 s along the $ y$ coordinate.

Must provide bool operator()(Point_2 p, Point_2 q) where true is returned iff
$ p_y < q_y$ , where $ p_y$ and $ q_y$ denote $ y$ coordinate of point $ p$
and $ q$ , respectively.

Returns: unspecified_type";

// SpatialSortingTraits_3
constexpr const char* SpatialSortingTraits_3__class__ = "All 3D spatial sorting algorithms, including sorting on the sphere, provided in CGAL are parameterized by a traits class Traits , which defines the primitives (objects and predicates) that the sorting algorithms use. SpatialSortingTraits_3 defines the complete set of primitives required in these functions and functors.";

constexpr const char* SpatialSortingTraits_3_Point_3 = "The point type on which the sorting algorithms operate.

Returns: unspecified_type";
constexpr const char* SpatialSortingTraits_3_Compute_x_3 = "Functor object type returning the $ x$ coordinate of a Point_3 .

Must provide FT operator()(Point_3 p) where FT can be used as argument of
CGAL::to_double .

Returns: unspecified_type";
constexpr const char* SpatialSortingTraits_3_Compute_y_3 = "Functor object type returning the $ y$ coordinate of a Point_3 .

Must provide FT operator()(Point_3 p) where FT can be used as argument of
CGAL::to_double .

Returns: unspecified_type";
constexpr const char* SpatialSortingTraits_3_Compute_z_3 = "Functor object type returning the $ z$ coordinate of a Point_3 .

Must provide FT operator()(Point_3 p) where FT can be used as argument of
CGAL::to_double .

Returns: unspecified_type";
constexpr const char* SpatialSortingTraits_3_Less_x_3 = "Binary predicate object type comparing Point_3 s along the $ x$ coordinate.

Must provide bool operator()(Point_3 p, Point_3 q) where true is returned iff
$ p_x < q_x$ , where $ p_x$ and $ q_x$ denote $ x$ coordinate of point $ p$
and $ q$ , respectively.

Returns: unspecified_type";
constexpr const char* SpatialSortingTraits_3_Less_y_3 = "Binary predicate object type comparing Point_3 s along the $ y$ coordinate.
...
Returns: unspecified_type";
constexpr const char* SpatialSortingTraits_3_Less_z_3 = "Binary predicate object type comparing Point_3 s along the $ z$ coordinate.

Must provide bool operator()(Point_3 p, Point_3 q) where true is returned iff
$ p_z < q_z$ , where $ p_z$ and $ q_z$ denote $ z$ coordinate of point $ p$
and $ q$ , respectively.

Returns: unspecified_type";

// SpatialSortingTraits_d
constexpr const char* SpatialSortingTraits_d__class__ = "All higher dimensional spatial sorting algorithms provided in CGAL are parameterized by a traits class Traits , which defines the primitives (objects and predicates) that the sorting algorithms use. SpatialSortingTraits_d defines the complete set of primitives required in these functions and functors.";

constexpr const char* SpatialSortingTraits_d_Point_d = "The point type on which the sorting algorithms operate.

Returns: unspecified_type";
constexpr const char* SpatialSortingTraits_d_Point_dimension_d = "Functor object type returning the dimension of a Point_d .

Must provide int operator()(Point_d p) returning the dimension of $ p$ .

Returns: unspecified_type";
constexpr const char* SpatialSortingTraits_d_Compute_coordinate_d = "Functor object type returning the coordinates of a Point_d .

Must provide FT operator()(Point_d p, int i) returning the $ i$ th coordinate
of $ p$ . FT is a type that can be used as argument of CGAL::to_double .

Returns: unspecified_type";
constexpr const char* SpatialSortingTraits_d_Less_coordinate_d = "Binary predicate object type comparing Point_d s along some coordinate.

Must provide bool operator()(Point_d p, Point_d q, int i) where true is
returned iff $ p_i < q_i$ , where $ p_i$ and $ q_i$ denote $ i$ th coordinate
of point $ p$ and $ q$ , respectively.
...
#endif // CGAL_PYTHON_DOCSTRINGS_SPATIAL_SORTING_H
