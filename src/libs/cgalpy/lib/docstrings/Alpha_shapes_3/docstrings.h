...
#ifndef CGAL_PYTHON_DOCSTRINGS_ALPHA_SHAPES_3_H
#define CGAL_PYTHON_DOCSTRINGS_ALPHA_SHAPES_3_H
...
// AlphaShapeCell_3
constexpr const char* AlphaShapeCell_3__class__ = "The concept AlphaShapeCell_3 describes the requirements for the base cell of an alpha shape.";

constexpr const char* AlphaShapeCell_3_NT = "A number type.

Must be the same as the number type used in the traits class of the
triangulation underlying the alpha shape.

Returns: unspecified_type";
constexpr const char* AlphaShapeCell_3_Alpha_status_iterator = "An iterator with value type CGAL::Alpha_status < NT > .

Returns: unspecified_type";
constexpr const char* AlphaShapeCell_3_AlphaShapeCell_3 = "default constructor.";
constexpr const char* AlphaShapeCell_3_AlphaShapeCell_3_1 = "constructor setting the incident vertices.
...
v3 : const Vertex_handle &";
constexpr const char* AlphaShapeCell_3_AlphaShapeCell_3_2 = "constructor setting the incident vertices and the neighboring cells.
...
v2 : const Vertex_handle &
v3 : const Vertex_handle &
n0 : const Cell_handle &
n1 : const Cell_handle &
n2 : const Cell_handle &
n3 : const Cell_handle &";
constexpr const char* AlphaShapeCell_3_get_alpha = "Returns the alpha value of the cell.

Returns: NT";
constexpr const char* AlphaShapeCell_3_get_facet_status = "Returns an iterator on the CGAL::Alpha_status < NT > of the facet i of the cell.

Parameters
----------
i : int

Returns: Alpha_status_iterator";
constexpr const char* AlphaShapeCell_3_set_alpha = "Sets the critical value of the cell.

Parameters
----------
alpha : const NT &";
constexpr const char* AlphaShapeCell_3_set_facet_status = "Sets the iterator pointing to the CGAL::Alpha_status < NT > of the facet i of the cell.

Parameters
----------
i : int
as : Alpha_status_iterator";

// AlphaShapeTraits_3
constexpr const char* AlphaShapeTraits_3__class__ = "The concept AlphaShapeTraits_3 describes the requirements for the geometric traits class of the underlying Delaunay triangulation of a basic alpha shape.";

constexpr const char* AlphaShapeTraits_3_FT = "A number type compatible with the type used for the points coordinate.

Returns: unspecified_type";
constexpr const char* AlphaShapeTraits_3_Compute_squared_radius_3 = "An object constructor able to compute:

the squared radius of the smallest circumscribing sphere of 4 points p0, p1,
p2, p3 , the squared radius of the smallest circumscribing sphere of 3 points
p0, p1, p2 , the squared radius of the smallest circumscribing sphere of 2
points p0, p1 , the squared radius of the smallest circumscribing sphere to a
single point p0 (which is FT(0) ).

Returns: unspecified_type";
constexpr const char* AlphaShapeTraits_3_AlphaShapeTraits_3 = "Default constructor.";

// AlphaShapeVertex_3
constexpr const char* AlphaShapeVertex_3__class__ = "The concept AlphaShapeVertex_3 describes the requirements for the base vertex of an alpha shape.";

constexpr const char* AlphaShapeVertex_3_Point = "Must be the same as the point type provided by the geometric traits class of the triangulation.

Returns: unspecified_type";
constexpr const char* AlphaShapeVertex_3_Alpha_status = "Must be CGAL::Alpha_status <NT> where NT is the number type used in the geometric traits class of the triangulation.

Returns: unspecified_type";
constexpr const char* AlphaShapeVertex_3_AlphaShapeVertex_3 = "default constructor.";
constexpr const char* AlphaShapeVertex_3_AlphaShapeVertex_3_1 = "constructor setting the point.

Parameters
----------
p : Point";
constexpr const char* AlphaShapeVertex_3_AlphaShapeVertex_3_2 = "constructor setting the point and an incident cell.

Parameters
----------
p : Point
c : const Cell_handle &";
constexpr const char* AlphaShapeVertex_3_get_alpha_status = "Returns a pointer the alpha status of the vertex.
...
In GENERAL mode a $ k$ simplex is REGULAR if it is on the boundary f the alpha
complex and belongs to a $ k+1$ simplex in this complex and it is SINGULAR if
it is a boundary simplex that is not included in a $ k+1$ simplex of the
complex. In REGULARIZED mode, for $ k=(0,1,2)$ each k-dimensional simplex of
...
FT::Approximate_nt is Interval_nt<Protected> with Protected=true . Access to
the exact value is provided through the function FT::Exact_nt exact() const
where FT::Exact_nt depends on the configuration of CGAL (it may be mpq_class ,
Gmpq , Quotient<CGAL::MP_Float> , etc). An overload for the function double
to_double(FT) is also available. Its precision is controlled through
FT::set_relative_precision_of_to_double() in exactly the same way as with
Lazy_exact_nt<NT> , so a call to to_double may trigger an exact evaluation. It
must be noted that an object of type FT is valid as long as the alpha shapes
class that creates it is valid and has not been modified. For convenience,
...
cleared before initialization. InputIterator must be an input iterator with
value type Point .
...
The result of this function depends on the mode of the Alpha-shape. In most
case, Alpha_shape_3::GENERAL is the most interesting one.
...
face and its alpha value are reported successively. OutputIterator must be an
output iterator accepting variables of type Object and FT . The class
Dispatch_output_iterator can be used for this purpose. The result of this
function dependents on the mode of the Alpha-shape. In most case,
Alpha_shape_3::GENERAL is the most interesting one.
...
alpha shape is equal to or smaller than nb_components .
...
simplices incident to the new ones are updated.
...
----------
os : std::ostream &
A : const Fixed_alpha_shape_3 < Dt > &
...
constexpr const char* FixedAlphaShapeCell_3_FixedAlphaShapeCell_3 = "default constructor.";
constexpr const char* FixedAlphaShapeCell_3_FixedAlphaShapeCell_3_1 = "constructor setting the incident vertices.
...
v2 : const Vertex_handle &
v3 : const Vertex_handle &";
constexpr const char* FixedAlphaShapeCell_3_FixedAlphaShapeCell_3_2 = "constructor setting the incident vertices and the neighboring cells.
...
n2 : const Cell_handle &
n3 : const Cell_handle &";
constexpr const char* FixedAlphaShapeCell_3_get_classification_type = "Returns the classification of the cell.

Returns: Classification_type";
constexpr const char* FixedAlphaShapeCell_3_get_facet_classification_type = "Returns the classification of the i-th facet of the cell.
...
Returns: Classification_type";
constexpr const char* FixedAlphaShapeCell_3_set_classification_type = "Sets the classification of the cell.

Parameters
----------
type : Classification_type";
constexpr const char* FixedAlphaShapeCell_3_set_facet_classification_type = "Sets the classification of the i-th facet of the cell.
...
constexpr const char* FixedAlphaShapeTraits_3__class__ = "The concept FixedAlphaShapeTraits_3 describes the requirements for the geometric traits class of the underlying Delaunay triangulation of a basic alpha shape with a fixed value alpha.";

constexpr const char* FixedAlphaShapeTraits_3_Comparison_result = "CGAL::Comparison_result or Uncertain<CGAL::Comparison_result>

Returns: unspecified_type";
constexpr const char* FixedAlphaShapeTraits_3_Compare_squared_radius_3 = "An object constructor able to compare the squared radius of the smallest circumscribing sphere of either four, three, two or one point(s) with a given value of alpha.

It provides: Comparison_result operator()(Point_3,Point_3,Point_3,Point_3)
Comparison_result operator()(Point_3,Point_3,Point_3) Comparison_result
operator()(Point_3,Point_3) Comparison_result operator()(Point_3)

Returns: unspecified_type";
constexpr const char* FixedAlphaShapeTraits_3_FixedAlphaShapeTraits_3 = "Default constructor.";

// FixedAlphaShapeVertex_3
constexpr const char* FixedAlphaShapeVertex_3__class__ = "The concept FixedAlphaShapeVertex_3 describes the requirements for the base vertex of a alpha shape with a fixed value alpha.";

constexpr const char* FixedAlphaShapeVertex_3_Point = "Must be the same as the point type provided by the geometric traits class of the triangulation.

Returns: unspecified_type";
constexpr const char* FixedAlphaShapeVertex_3_FixedAlphaShapeVertex_3 = "default constructor.";
constexpr const char* FixedAlphaShapeVertex_3_FixedAlphaShapeVertex_3_1 = "constructor setting the point.

Parameters
----------
p : Point";
constexpr const char* FixedAlphaShapeVertex_3_FixedAlphaShapeVertex_3_2 = "constructor setting the point and an incident cell.

Parameters
----------
p : Point
c : const Cell_handle &";
constexpr const char* FixedAlphaShapeVertex_3_is_on_chull = "Returns a boolean indicating whether the point is on the convex hull of the point of the triangulation.

Returns: bool";
constexpr const char* FixedAlphaShapeVertex_3_get_classification_type = "Returns the classification of the vertex.

Returns: Classification_type";
constexpr const char* FixedAlphaShapeVertex_3_set_classification_type = "Sets the classification of the vertex.

Parameters
----------
type : Classification_type";
constexpr const char* FixedAlphaShapeVertex_3_is_on_chull_1 = "Sets whether the vertex is on the convex hull.
...
constexpr const char* FixedWeightedAlphaShapeTraits_3__class__ = "The concept FixedWeightedAlphaShapeTraits_3 describes the requirements for the geometric traits class of the underlying regular triangulation of a weighted alpha shape with fixed alpha value.";

constexpr const char* FixedWeightedAlphaShapeTraits_3_Comparison_result = "CGAL::Comparison_result or Uncertain<CGAL::Comparison_result>

Returns: unspecified_type";
constexpr const char* FixedWeightedAlphaShapeTraits_3_Compare_weighted_squared_radius_3 = "An object constructor able to compare the squared radius of the smallest sphere orthogonal to either four, three, two or one weighted point(s) to a given value of alpha.

It provides: Comparison_result operator()(Weighted_point_3 ,Weighted_point_3
,Weighted_point_3 ,Weighted_point_3 ) Comparison_result
operator()(Weighted_point_3 ,Weighted_point_3 ,Weighted_point_3 )
Comparison_result operator()(Weighted_point_3 ,Weighted_point_3 )
Comparison_result operator()(Weighted_point_3 )

Returns: unspecified_type";
constexpr const char* FixedWeightedAlphaShapeTraits_3_FixedWeightedAlphaShapeTraits_3 = "default constructor.";

// WeightedAlphaShapeTraits_3
constexpr const char* WeightedAlphaShapeTraits_3__class__ = "The concept WeightedAlphaShapeTraits_3 describes the requirements for the geometric traits class of the underlying regular triangulation of a weighted alpha shape.";

constexpr const char* WeightedAlphaShapeTraits_3_FT = "A number type compatible with the type used for the points coordinates.

Returns: unspecified_type";
constexpr const char* WeightedAlphaShapeTraits_3_Compute_squared_radius_smallest_orthogonal_sphere_3 = "An object constructor able to compute the squared radius of the smallest sphere orthogonal to four weighted points p0, p1, p2, p3 , and the squared radius of the smallest sphere orthogonal to three weighted points p0, p1, p2 , and the squared radius of smallest sphere orthogonal to two weighted points p0, p1 , and the squared radius of the smallest sphere orthogonal to a single point p0 .
...
#endif // CGAL_PYTHON_DOCSTRINGS_ALPHA_SHAPES_3_H
