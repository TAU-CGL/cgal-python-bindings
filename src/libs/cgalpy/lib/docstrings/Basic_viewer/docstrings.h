...
// Package: Basic_viewer
#ifndef CGAL_PYTHON_DOCSTRINGS_BASIC_VIEWER_H
#define CGAL_PYTHON_DOCSTRINGS_BASIC_VIEWER_H
...
Kernel::Vector_2 or Kernel::Vector_3 .
...
constexpr const char* GraphicsSceneOptions__class__ = "The concept GraphicsSceneOptions defines data and methods used to tune the way that the cells of a given data structure of CGAL are considered for drawing or to be added into a graphics scene.";

constexpr const char* GraphicsSceneOptions_DS = "A data structure of CGAL.

Returns: unspecified_type";
constexpr const char* GraphicsSceneOptions_vertex_descriptor = "A descriptor of vertices of DS .

Returns: unspecified_type";
constexpr const char* GraphicsSceneOptions_edge_descriptor = "A descriptor of edges of DS .

Returns: unspecified_type";
constexpr const char* GraphicsSceneOptions_face_descriptor = "A descriptor of faces of DS .

Returns: unspecified_type";
constexpr const char* GraphicsSceneOptions_ignore_vertex = "std::function that returns true if the given vertex must be ignored, false otherwise.

Returns false by default.

Returns: std::function< bool(const DS &, vertex_descriptor )>";
constexpr const char* GraphicsSceneOptions_ignore_edge = "std::function that returns true if the given edge must be ignored, false otherwise.

Returns true by default.

Returns: std::function< bool(const DS &, edge_descriptor )>";
constexpr const char* GraphicsSceneOptions_ignore_face = "std::function that returns true if the given face must be ignored, false otherwise.

Returns true by default.

Returns: std::function< bool(const DS &, face_descriptor )>";
constexpr const char* GraphicsSceneOptions_is_vertex_colored = "std::function that returns true if the given vertex is colored, false otherwise.

Returns false by default. For non colored vertices, this is the role of the
user of a graphic scene to decide which color must be used (cf. for example
Basic_viewer , vertices_mono_color ).

Returns: std::function< bool(const DS &, vertex_descriptor )>";
constexpr const char* GraphicsSceneOptions_is_edge_colored = "std::function that returns true if the given edge is colored, false otherwise.

For non colored edges, this is the role of the user of a graphic scene to
decide which color must be used (cf. for example Basic_viewer ,
edges_mono_color ). Returns false by default.

Returns: std::function< bool(const DS &, edge_descriptor )>";
constexpr const char* GraphicsSceneOptions_is_face_colored = "std::function that returns true if the given face is colored, false otherwise.

For non colored faces, this is the role of the user of a graphic scene to
decide which color must be used (cf. for example Basic_viewer ,
faces_mono_color ). Returns false by default.

Returns: std::function< bool(const DS &, face_descriptor )>";
constexpr const char* GraphicsSceneOptions_is_face_wireframe = "std::function that returns true if the given face is in wireframe, false otherwise.

Returns false by default.

Returns: std::function< bool(const DS &, face_descriptor )>";
constexpr const char* GraphicsSceneOptions_vertex_color = "std::function that returns the color of the given vertex.

nullptr by default.

Returns: std::function< CGAL::IO::Color(const DS &, vertex_descriptor )>";
constexpr const char* GraphicsSceneOptions_edge_color = "std::function that returns the color of the given edge.

nullptr by default.

Returns: std::function< CGAL::IO::Color(const DS &, edge_descriptor )>";
constexpr const char* GraphicsSceneOptions_face_color = "std::function that returns the color of the given face.

nullptr by default.

Returns: std::function< CGAL::IO::Color(const DS &, face_descriptor )>";
constexpr const char* GraphicsSceneOptions_ignore_all_vertices = "ignores all vertices when b is true ; otherwise ignores only vertices for which ignore_vertex() returns true .

Parameters
----------
b : bool";
constexpr const char* GraphicsSceneOptions_ignore_all_edges = "ignores all edges when b is true ; otherwise ignores only edges for which ignore_edge() returns true .

Parameters
----------
b : bool";
constexpr const char* GraphicsSceneOptions_ignore_all_faces = "ignores all faces when b is true ; otherwise ignores only faces for which ignore_face() returns true .
...
constexpr const char* GraphicsSceneOptionsWithVolumes__class__ = "The concept GraphicsSceneOptionsWithVolumes extends the concept GraphicsSceneOptions to deal with data structures that represent volumes.";

constexpr const char* GraphicsSceneOptionsWithVolumes_volume_descriptor = "A descriptor of volumes of DS .

Returns: unspecified_type";
constexpr const char* GraphicsSceneOptionsWithVolumes_ignore_volume = "std::function that returns true if the given volume must be ignored, false otherwise.

Returns false by default.

Returns: std::function< bool(const DS &, volume_descriptor )>";
constexpr const char* GraphicsSceneOptionsWithVolumes_is_volume_colored = "std::function that returns true if the given volume is colored, false otherwise.

For non colored volumes, this is the role of the user of a graphic scene to
decide which color must be used (cf. for example Basic_viewer ,
faces_mono_color ). Returns false by default.

Returns: std::function< bool(const DS &, volume_descriptor )>";
constexpr const char* GraphicsSceneOptionsWithVolumes_is_volume_wireframe = "std::function that returns true if the given volume is in wireframe, false otherwise.

Returns false by default.

Returns: std::function< bool(const DS &, volume_descriptor )>";
constexpr const char* GraphicsSceneOptionsWithVolumes_volume_color = "std::function that returns the color of the given volume, i.e.

the color of all the faces of this volume. nullptr by default.

Returns: std::function< CGAL::IO::Color(const DS &, volume_descriptor )>";
constexpr const char* GraphicsSceneOptionsWithVolumes_ignore_all_volumes = "ignores all volumes when b is true ; otherwise ignore only volumes for which ignore_volume() returns true .
...
#endif // CGAL_PYTHON_DOCSTRINGS_BASIC_VIEWER_H
