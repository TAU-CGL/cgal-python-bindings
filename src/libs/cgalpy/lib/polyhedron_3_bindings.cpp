...
void export_polyhedron_3(py::module_& m) {
  ...
  if (! add_attr<Prn>(m, "Polyhedron_3")) {
    py::class_<Prn> prn_c(m, "Polyhedron_3", doc::Polyhedron_3__class__);
    prn_c.def(py::init<>(), doc::Polyhedron_3_Polyhedron_3)
      .def(py::init<const Prn&>(), py::arg("other"), doc::Polyhedron_3_Polyhedron_3_1)
      .def(py::init<const pol3::Traits&>(), py::arg("traits"))
      .def("add_facet_to_border", &Prn::add_facet_to_border, doc::Polyhedron_3_add_facet_to_border)
      .def("add_vertex_and_facet_to_border", &Prn::add_vertex_and_facet_to_border, doc::Polyhedron_3_add_vertex_and_facet_to_border)
      .def("bytes", &Prn::bytes, doc::Polyhedron_3_bytes)
      .def("bytes_reserved", &Prn::bytes_reserved, doc::Polyhedron_3_bytes_reserved)
      .def("capacity_of_facets", &Prn::capacity_of_facets, doc::Polyhedron_3_capacity_of_facets)
      .def("capacity_of_halfedges", &Prn::capacity_of_halfedges, doc::Polyhedron_3_capacity_of_halfedges)
      .def("capacity_of_vertices", &Prn::capacity_of_vertices, doc::Polyhedron_3_capacity_of_vertices)
      .def("clear", &Prn::clear, doc::Polyhedron_3_clear)
      .def("create_center_vertex", &Prn::create_center_vertex, doc::Polyhedron_3_create_center_vertex)
      .def("erase_all", &Prn::erase_all)
      .def("erase_center_vertex", &Prn::erase_center_vertex, doc::Polyhedron_3_erase_center_vertex)
      .def("erase_connected_component", &Prn::erase_connected_component, doc::Polyhedron_3_erase_connected_component)
      .def("erase_facet", &Prn::erase_facet, doc::Polyhedron_3_erase_facet)
      .def("fill_hole", &Prn::fill_hole, doc::Polyhedron_3_fill_hole)
      .def("flip_edge", &Prn::flip_edge, doc::Polyhedron_3_flip_edge)
      .def("inside_out", &Prn::inside_out, doc::Polyhedron_3_inside_out)
      .def("is_closed", &Prn::is_closed, doc::Polyhedron_3_is_closed)
      .def("is_empty", &Prn::is_empty, doc::Polyhedron_3_empty)
      .def("is_tetrahedron", &pol3::is_tetrahedron, py::arg("halfedge"), doc::Polyhedron_3_is_tetrahedron)
      .def("is_triangle", &Prn::is_triangle, doc::Polyhedron_3_is_triangle)
      .def("is_valid", &Prn::is_valid, doc::Polyhedron_3_is_valid)
      .def("join_facet", &Prn::join_facet, doc::Polyhedron_3_join_facet)
      .def("join_loop", &Prn::join_loop, doc::Polyhedron_3_join_loop)
      .def("join_vertex", &Prn::join_vertex, doc::Polyhedron_3_join_vertex)
      .def("keep_largest_connected_components", &Prn::keep_largest_connected_components, doc::Polyhedron_3_keep_largest_connected_components)
      .def("make_hole", &Prn::make_hole, doc::Polyhedron_3_make_hole)
      .def("make_tetrahedron", &pol3::make_tetrahedron1, ri,
            py::arg("p1"), py::arg("p2"), py::arg("p3"), py::arg("p4"),
            doc::Polyhedron_3_make_tetrahedron_1)
      .def("make_tetrahedron", &pol3::make_tetrahedron2, ri,
            doc::Polyhedron_3_make_tetrahedron)
      .def("normalize_border", &Prn::normalize_border, doc::Polyhedron_3_normalize_border)
      .def("normalized_border_is_valid", &Prn::normalized_border_is_valid, doc::Polyhedron_3_normalized_border_is_valid)
      .def("size_of_border_edges", &Prn::size_of_border_edges, doc::Polyhedron_3_size_of_border_edges)
      .def("size_of_border_halfedges", &Prn::size_of_border_halfedges, doc::Polyhedron_3_size_of_border_halfedges)
      .def("size_of_facets", &Prn::size_of_facets, doc::Polyhedron_3_size_of_facets)
      .def("size_of_halfedges", &Prn::size_of_halfedges, doc::Polyhedron_3_size_of_halfedges)
      .def("size_of_vertices", &Prn::size_of_vertices, doc::Polyhedron_3_size_of_vertices)
      .def("split_facet", &Prn::split_facet, doc::Polyhedron_3_split_facet)
      .def("split_loop", &Prn::split_loop, doc::Polyhedron_3_split_loop)
      .def("split_vertex", &Prn::split_vertex, doc::Polyhedron_3_split_vertex)
      .def("make_triangle", &pol3::make_triangle_empty,
            doc::Polyhedron_3_make_triangle)
      .def("make_triangle", &pol3::make_triangle,
            py::arg("p1"), py::arg("p2"), py::arg("p3"),
            doc::Polyhedron_3_make_triangle_1)
      .def("delegate", &Prn::delegate, doc::Polyhedron_3_delegate)
      .def("is_pure_quad", py::overload_cast<>(&Prn::is_pure_quad, py::const_), doc::Polyhedron_3_is_pure_quad)
      .def("is_pure_bivalent", py::overload_cast<>(&Prn::is_pure_bivalent, py::const_), doc::Polyhedron_3_is_pure_bivalent)
      .def("is_pure_trivalent", py::overload_cast<>(&Prn::is_pure_trivalent, py::const_), doc::Polyhedron_3_is_pure_trivalent)
      .def("is_pure_triangle", py::overload_cast<>(&Prn::is_pure_triangle, py::const_), doc::Polyhedron_3_is_pure_triangle)
      ;
