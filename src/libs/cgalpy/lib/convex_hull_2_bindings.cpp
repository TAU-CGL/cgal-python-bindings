...
void export_convex_hull_2(py::module_& m) {
  m.def("ch_akl_toussaint", &ch_akl_toussaint, py::arg("lst"));
  m.def("ch_bykat", &ch_bykat, py::arg("lst"));
  m.def("ch_eddy", &ch_eddy, py::arg("lst"));
  m.def("ch_graham_andrew", &ch_graham_andrew, py::arg("lst"));
  m.def("ch_jarvis", &ch_jarvis, py::arg("lst"));
  m.def("ch_melkman", &ch_melkman, py::arg("lst"));
  m.def("convex_hull_2", &convex_hull_2, py::arg("lst"));
  m.def("is_ccw_strongly_convex_2", &is_ccw_strongly_convex_2, py::arg("lst"));
  m.def("is_cw_strongly_convex_2", &is_cw_strongly_convex_2, py::arg("lst"));
  m.def("lower_hull_points_2", lower_hull_points_2, py::arg("lst"));
  m.def("upper_hull_points_2", upper_hull_points_2, py::arg("lst"));
}
