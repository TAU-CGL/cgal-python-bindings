...
#if CGALPY_POL3_GEOMETRY_TRAITS == CGALPY_POL3_WITH_NORMALS_GEOMETRY_TRAITS
    .def("normal", [](const Face& f) { return f.plane(); }, ri, pol3_doc::Polyhedron_3_Facet_plane)
    .def("set_normal", [](Face& f, const Vector_3& normal) { f.plane() = normal; }, py::arg("normal"), pol3_doc::Polyhedron_3_Facet_plane_1)
#else
    .def("plane", [](const Face& f) { return f.plane(); }, ri, pol3_doc::Polyhedron_3_Facet_plane)
    .def("set_plane", [](Face& f, const Plane_3& plane) { f.plane() = plane; }, py::arg("plane"), pol3_doc::Polyhedron_3_Facet_plane_1)
#endif
