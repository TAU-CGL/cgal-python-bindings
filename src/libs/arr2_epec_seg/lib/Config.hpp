...
#elif CGALPY_KERNEL == CGALPY_EPIEC_KERNEL
#define CGALPY_KERNEL_SHORT_NAME epiec
#endif

#if CGALPY_TRAITS == CGALPY_ARR_LINEAR_TRAITS
#define CGALPY_TRAITS_SHORT_NAME linear
#elif CGALPY_TRAITS == CGALPY_ARR_SEGMENT_TRAITS
#define CGALPY_TRAITS_SHORT_NAME seg
#elif CGALPY_TRAITS == CGALPY_ARR_NON_CACHING_SEGMENT_TRAITS
#define CGALPY_TRAITS_SHORT_NAME ncseg
#elif CGALPY_TRAITS == CGALPY_ARR_CONIC_TRAITS
#define CGALPY_TRAITS_SHORT_NAME conic
#elif CGALPY_TRAITS == CGALPY_ARR_ALGEBRAIC_SEGMENT_TRAITS
#define CGALPY_TRAITS_SHORT_NAME alg
#elif CGALPY_TRAITS == CGALPY_ARR_CIRCLE_SEGMENT_TRAITS
...
#define CGALPY_MODULE_NAME SET_MODULE_NAME_EX(arr2, CGALPY_KERNEL_SHORT_NAME, CGALPY_TRAITS_SHORT_NAME, fex)
#endif
#if CGALPY_DCEL == CGALPY_EXTENDED_DCEL
#define CGALPY_MODULE_NAME SET_MODULE_NAME_EX(arr2, CGALPY_KERNEL_SHORT_NAME, CGALPY_TRAITS_SHORT_NAME, ex)
#endif
