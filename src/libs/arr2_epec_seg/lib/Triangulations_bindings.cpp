...
typedef Triangulation_2::Vertex_iterator                        TVertex_iterator;
...
typedef Triangulation_2::Edge_iterator                          TEdges_iterator;
...
typedef Triangulation_2::Face_iterator                          TFace_iterator;
...
void export_triangulation(C c)
{
  ...
  c
    ...
    .def<Segment_2(T::*)(const TEdge&) const>("segment", &T::segment)
    .def<bool (T::*)(const TEdge&) const>("is_infinite", &T::is_infinite)
