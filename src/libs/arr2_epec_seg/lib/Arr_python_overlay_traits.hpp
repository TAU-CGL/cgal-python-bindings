 ...
 * object of type Data1 and Data2 is computed using the python functor
 * Overlay_face_data.
 */
...
public:
  ...
  typedef  Python_functor<data_type>                  Overlay_face_data;
...
public:
  Arr_python_overlay_traits(bp::object py_functor) : Arr_default_overlay_traits()
  {
