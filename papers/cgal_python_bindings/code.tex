...
types of the topological features of the data structures, for example,
the DCEL of the arrangement or the triangulation data structure of a
triangulation. When developing code in pure C++, there is no
restriction on the property used to extend the data structure.
