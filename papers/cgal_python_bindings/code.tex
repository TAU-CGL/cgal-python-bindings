...
last argument, namely \cppLstinline{traits}, enables the creation of
extended DCEL records of the output arrangement from the properties of
the corresponding DCEL records of the input arrangements. All three
