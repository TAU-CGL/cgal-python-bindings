...
\tikzset{tableBindingSelection/.style={table,
  ...
  column 2/.style={nodes={text width=4.0em}},
  column 3/.style={nodes={text width=3.0em}},
  column 4/.style={nodes={text width=11.7em}}}}
...
\tikzset{tableModuleName/.style={table,
  ...
  column 2/.style={nodes={text width=14em}},
  column 3/.style={nodes={text width=6.5em}}}}
