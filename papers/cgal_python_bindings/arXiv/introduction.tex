...
of the \cgal{} library---a component that is particularly intricate,
...
There is a large community of users of the \cgal{} arrangements
...
to resolve these difficulties and make the arrangements packages more
...
code of \cgal{} that resides in header file, (the name of which
...
where the type of the objects to be bound are closely tied with the
...
arrangement class template and an instance of the 2D polygon-set class
...
in Section~\ref{sec:comp}.
%
General instructions for dynamically generating bindings are presented
