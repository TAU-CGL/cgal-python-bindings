...
resolved during compile time (of the C++ modules). For example, the
programmer needs to choose among a dozen types of curves (e.g., line
segments, circular arcs, geodesic arcs on a sphere, or polycurves of
any curve type) to yield a desired arrangement type. While bindings
