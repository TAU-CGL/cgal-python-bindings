...
\myLstinline{epic} & \myLstinline{Exact_predicates_inexact_constructions_kernel}\\
\myLstinline{epec} & \myLstinline{Exact_predicates_exact_constructions_kernel}\\
\myLstinline{epecws} & \myLstinline{Exact_predicates_exact_constructions_kernel_with_sqrt}\\
  };
 \end{tikzpicture}
