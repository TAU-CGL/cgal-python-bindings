...
magnitude of existing and well-tested code in Fortrant, C, and C++, is
...
\myLstinline{cmake-gui}, which also includes a graphical user interface
...
these types in advance is practically impossible. Moreover, in some
...
in Section~\ref{sec:comp}. General instructions for dynamically
