...
generator.  It is used to control the software building process using
...
\myLstinline{cmake} in terminal and specifies the directory which
contains the root \myLstinline{CMakeLists.txt}.
...
generate the C++ Python bindings for several objects concurrently
...
that depends on \cgal{} only depends on (i) source code of \cgal{}
...
bindings, thus defeating these problems.
