...
enourmous. The Python/C API, the module that enables the usage of
external modules, developed in Fortrant, C, or C++, from Python code,
or embedding Python code in code written in other languages is very
...
exploitation of existing code in Fortrant, C, or C++, as well as the
replacement of critical sections written in these languages when speed
is essential.
...
result, the software of \cgal{} is stable despite the use of (inexact)
...
each one of its template parameters is substituted with a model of one
or more concepts associated with the template parameter.
