...
# Default
SET(CGALPY_TRID_DIMENSION 2 CACHE INTERNAL "")
...
function(select_triangulation_d)
  if (${CGALPY_TRIANGULATION_D_BINDINGS})
    ...
    if (${CGALPY_TRID_FACE_WITH_DATA})
      add_definitions(-DCGALPY_TRID_FACE_WITH_DATA=)
    endif()
...
function(get_triangulation_d_lib_name ret)
  ...
  list(GET CGALPY_TRID_STORAGE_POLICY_SHORT_NAMES ${CGALPY_TRID_STORAGE_POLICY} part2)
  capitalize_first(part2)
  list(GET CGALPY_TRID_DIMENSION_TAG_NAME ${CGALPY_TRID_DIMENSION_TAG} part3)
  capitalize_first(part3)
  if (${CGALPY_TRID_DIMENSION_TAG} STREQUAL ${CGALPY_TRID_DIMENSION_TAG_STATIC})
    set(part3 ${CGALPY_TRID_DIMENSION})
  endif()
  set(${ret} "trid${part1}${part2}${part3}" PARENT_SCOPE)
endfunction()
