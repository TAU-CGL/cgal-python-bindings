...
function(select_arr_2_geometry_traits)
  if     ("${CGALPY_ARR_2_GEOMETRY_TRAITS_NAME}" STREQUAL "linear")
    set(CGALPY_ARR_2_GEOMETRY_TRAITS ${CGALPY_ARR_2_LINEAR_GEOMETRY_TRAITS} CACHE INTERNAL "")
  ...
  elseif ("${CGALPY_ARR_2_GEOMETRY_TRAITS_NAME}" STREQUAL "nonCachingSegment")
    set(CGALPY_ARR_2_GEOMETRY_TRAITS ${CGALPY_ARR_2_NON_CACHING_SEGMENT_GEOMETRY_TRAITS} CACHE INTERNAL "")
  elseif ("${CGALPY_ARR_2_GEOMETRY_TRAITS_NAME}" STREQUAL "conic")
    set(CGALPY_ARR_2_GEOMETRY_TRAITS ${CGALPY_ARR_2_CONIC_GEOMETRY_TRAITS} CACHE INTERNAL "")
  elseif ("${CGALPY_ARR_2_GEOMETRY_TRAITS_NAME}" STREQUAL "algebraic")
    set(CGALPY_ARR_2_GEOMETRY_TRAITS ${CGALPY_ARR_2_ALGEBRAIC_SEGMENT_GEOMETRY_TRAITS} CACHE INTERNAL "")
  elseif ("${CGALPY_ARR_2_GEOMETRY_TRAITS_NAME}" STREQUAL "circleSegment")
    set(CGALPY_ARR_2_GEOMETRY_TRAITS ${CGALPY_ARR_2_CIRCLE_SEGMENT_GEOMETRY_TRAITS} CACHE INTERNAL "")
  endif()
...
function(select_arr_2_dcel)
  ...
  elseif ("${CGALPY_ARR_2_DCEL_NAME}" STREQUAL "faceExtended")
    set(CGALPY_ARR_2_DCEL ${CGALPY_ARR_2_FACE_EXTENDED_DCEL} CACHE INTERNAL "")
  elseif ("${CGALPY_ARR_2_DCEL_NAME}" STREQUAL "halfedgeExtended")
    set(CGALPY_ARR_2_DCEL ${CGALPY_ARR_2_HALFEDGE_EXTENDED_DCEL} CACHE INTERNAL "")
  elseif ("${CGALPY_ARR_2_DCEL_NAME}" STREQUAL "vertexExtended")
    set(CGALPY_ARR_2_DCEL ${CGALPY_ARR_2_VERTEX_EXTENDED_DCEL} CACHE INTERNAL "")
  elseif ("${CGALPY_ARR_2_DCEL_NAME}" STREQUAL "allExtended")
    set(CGALPY_ARR_2_DCEL ${CGALPY_ARR_2_ALL_EXTENDED_DCEL} CACHE INTERNAL "")
  endif()
