...
set(CGALPY_TRI3_TYPE_PLAIN              0)
set(CGALPY_TRI3_TYPE_REGULAR            1)
set(CGALPY_TRI3_TYPE_DELAUNAY           2)
set(CGALPY_TRI3_TYPE_PERIODIC3_DELAUNAY 3)
set(CGALPY_TRI3_TYPE_SHORT_NAMES plain reg del p3del)
set(CGALPY_TRI3_TYPE_NAMES plain regular delaunay periodic3Delaunay)
# Default
SET(CGALPY_TRI3_TYPE ${CGALPY_TRI3_TYPE_REGULAR} CACHE INTERNAL "")
SET(CGALPY_TRI3_TYPE_NAME "regular" CACHE STRING "The 3D Triangulation")
set_property(CACHE CGALPY_TRI3_TYPE_NAME PROPERTY STRINGS plain regular delaunay periodic3Delaunay)
...
function(select_triangulation_3)
  if (${CGALPY_TRIANGULATION_3_BINDINGS})
    ...
    if    ("${CGALPY_TRI3_TYPE_NAME}" STREQUAL "plain")
      set(CGALPY_TRI3_TYPE ${CGALPY_TRI3_TYPE_PLAIN} CACHE INTERNAL "")
    elseif("${CGALPY_TRI3_TYPE_NAME}" STREQUAL "regular")
      set(CGALPY_TRI3_TYPE ${CGALPY_TRI3_TYPE_REGULAR} CACHE INTERNAL "")
    elseif("${CGALPY_TRI3_TYPE_NAME}" STREQUAL "delaunay")
      set(CGALPY_TRI3_TYPE ${CGALPY_TRI3_TYPE_DELAUNAY} CACHE INTERNAL "")
    elseif("${CGALPY_TRI3_TYPE_NAME}" STREQUAL "periodic3Delaunay")
      set(CGALPY_TRI3_TYPE ${CGALPY_TRI3_TYPE_PERIODIC3_DELAUNAY} CACHE INTERNAL "")
    endif()
    add_definitions(-DCGALPY_TRI3_TYPE=${CGALPY_TRI3_TYPE})
  endif()
endfunction()

function(get_triangulation_3_lib_name ret)
  list(GET CGALPY_TRI3_TYPE_SHORT_NAMES ${CGALPY_TRI3_TYPE} CGALPY_TRI3_TYPE_PART)
  ...
  set(${ret} "tri3_${CGALPY_TRI3_TYPE_PART}_${CGALPY_VERTEX_BASE_PART}_${CGALPY_TRI3_CELL_BASE_PART}" PARENT_SCOPE)
endfunction()
