...
set(CGALPY_TRI3_PERIODIC3          3)
set(CGALPY_TRI3_PERIODIC3_REGULAR  4)
set(CGALPY_TRI3_PERIODIC3_DELAUNAY 5)

set(CGALPY_TRI3_SHORT_NAMES plain reg del p3del)
set(CGALPY_TRI3_NAMES plain regular delaunay periodic3 periodic3Regular periodic3Delaunay)
# Default
SET(CGALPY_TRI3 ${CGALPY_TRI3_REGULAR} CACHE INTERNAL "")
SET(CGALPY_TRI3_NAME "regular" CACHE STRING "The 3D Triangulation")
set_property(CACHE CGALPY_TRI3_NAME PROPERTY STRINGS plain regular delaunay periodic3 periodic3Regular periodic3Delaunay)

# 3D Triangulation traits
set(CGALPY_TRI3_TRAITS_KERNEL             0)
set(CGALPY_TRI3_TRAITS_PERIODIC3          1)
set(CGALPY_TRI3_TRAITS_PERIODIC3_REGULAR  2)
set(CGALPY_TRI3_TRAITS_PERIODIC3_DELAUNAY 3)

set(CGALPY_TRI3_TRAITS_SHORT_NAMES ker p3d)
set(CGALPY_TRI3_TRAITS_NAMES kernel periodic3 periodic3Regular periodic3Delaunay)
# Default (depends on the selected triangulation
if("${CGALPY_TRI3}" EQUAL ${CGALPY_TRI3_PERIODIC3})
  SET(CGALPY_TRI3_TRAITS ${CGALPY_TRI3_TRAITS_PERIODIC3} CACHE INTERNAL "")
  SET(CGALPY_TRI3_TRAITS_NAME "periodic3" CACHE STRING "The 3D Triangulation traits")
elseif("${CGALPY_TRI3}" EQUAL ${CGALPY_TRI3_PERIODIC3_REGULAR})
  SET(CGALPY_TRI3_TRAITS ${CGALPY_TRI3_TRAITS_REGULAR} CACHE INTERNAL "")
  SET(CGALPY_TRI3_TRAITS_NAME "periodic3Regular" CACHE STRING "The 3D Triangulation traits")
elseif("${CGALPY_TRI3}" EQUAL ${CGALPY_TRI3_PERIODIC3_DELAUNAY})
  SET(CGALPY_TRI3_TRAITS ${CGALPY_TRI3_TRAITS_DELAUNAY} CACHE INTERNAL "")
  SET(CGALPY_TRI3_TRAITS_NAME "periodic3Delaunay" CACHE STRING "The 3D Triangulation traits")
else()
...
set_property(CACHE CGALPY_TRI3_TRAITS_NAME PROPERTY STRINGS kernel periodic3 periodic3Regular periodic3Delaunay)
...
function(select_tri3_traits)
  if     ("${CGALPY_TRI3_TRAITS_NAME}" STREQUAL "kernel")
    set(CGALPY_TRI3_TRAITS ${CGALPY_TRI3_TRAITS_KERNEL} CACHE INTERNAL "")
  elseif ("${CGALPY_TRI3_TRAITS_NAME}" STREQUAL "periodic3")
    set(CGALPY_TRI3_TRAITS ${CGALPY_TRI3_TRAITS_PERIODIC3} CACHE INTERNAL "")
  elseif ("${CGALPY_TRI3_TRAITS_NAME}" STREQUAL "periodic3Regular")
    set(CGALPY_TRI3_TRAITS ${CGALPY_TRI3_TRAITS_PERIODIC3_REGULAR} CACHE INTERNAL "")
...
function(select_tri3)
  ...
  elseif("${CGALPY_TRI3_NAME}" STREQUAL "periodic3")
    set(CGALPY_TRI3 ${CGALPY_TRI3_PERIODIC3} CACHE INTERNAL "")
  elseif("${CGALPY_TRI3_NAME}" STREQUAL "periodic3Regular")
    set(CGALPY_TRI3 ${CGALPY_TRI3_PERIODIC3_REGULAR} CACHE INTERNAL "")
